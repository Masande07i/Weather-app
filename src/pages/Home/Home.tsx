...
const getWeather = async (city: string) => {
  ...
  const response = await fetch(`https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/${encodeURIComponent(city)}?key=${import.meta.env.VITE_API_KEY}`)
  if (!response.ok) {
